  ...
  (:functions
    ...
    (:action turn-right; Girar a la derecha
     ...
     (:action give; Entregar un item a un personaje
       ...
       :precondition (and (at ?z ?p) (at ?z ?n) (has-object ?p ?o) (not(is-bikini ?o)) (not(is-sneaker ?o)))
       :effect(and (not (has-object ?p ?o)) (hands-empty ?p) (supplied ?n) (increase (total-score) (score ?o ?n)))
     )
    )
